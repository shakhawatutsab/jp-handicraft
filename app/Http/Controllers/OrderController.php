    ...
    public static function products(): array
    {
        return [
            [
                ...
                'features' => ['প্রিমিয়াম সুতি কাপড়', 'হাতে সেলাই করা নকশা', 'সাথে ওড়না ও সালোয়ার'],
            ],
            [
                'id' => 'JML-02',
                ...
                'image' => 'product-2.jpg',
                'regular' => 2200, 'offer' => 1750,
                'features' => ['নরম সুতি কাপড়', 'ফুলেল হাতের কাজ', 'রং না ওঠার গ্যারান্টি'],
            ],
            [
                'id' => 'JML-03',
                'title' => 'নকশি কাঁথা স্টিচ থ্রি-পিস - কোড: JML-03',
                'image' => 'product-3.jpg',
                'regular' => 2200, 'offer' => 1750,
                'features' => ['আরামদায়ক সুতি', 'নকশি কাঁথা স্টিচ', 'উৎসব ও দৈনন্দিনের জন্য'],
            ],
            [
                'id' => 'JML-04',
                'title' => 'নেভি ব্লু কারুকাজের থ্রি-পিস - কোড: JML-04',
                'image' => 'product-4.jpg',
                'regular' => 2200, 'offer' => 1750,
                'features' => ['ঘন বুননের সুতি', 'হাতের এমব্রয়ডারি', 'জর্জেট ওড়না'],
            ],
        ];
    }
